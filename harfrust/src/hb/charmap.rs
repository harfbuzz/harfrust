...
use read_fonts::{
    FontRef, TableProvider, tables::cmap::{Cmap, Cmap14, CmapSubtable, MapVariant}, types::GlyphId
};
...
impl<'a> Charmap<'a> {
    pub fn new(font: &impl TableProvider<'a>, table_ranges: &TableRanges, cache: &'a cache_t) -> Self {
